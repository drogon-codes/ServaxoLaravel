    ...
    <div class="_1U6Yu _2nuC5">
        <div class="rui-SB2Uw PZezW">
            <div class="rui-2SwH7 rui-yyNoO rui-24mBx rui-2DNls rui-1JF_2 rui-3SQyb rui-1SnDg rui-2wP6c">
                <h1 class="o_CSw" style="font-size: 50px;"><span>Edit your Ad</span></h1>
            ...
            @foreach($olddata as $d)
             <form action="/saveads" method="post" enctype="multipart/form-data" id="form1">
                    ...
                    <div class="rui-2SwH7 rui-1JF_2">
                                    ...
                                    <div class="rui-2zbKc">
                                        ...
                                        <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                            <select id="cid" onchange="loadModel(this.value);" name="cid" class="rui-1ekfu rui-98Wif" data-aut-id="ddmake" >
                                                 <option value=""></option>
                                                @foreach($brand as $m)
                                               <option value="{{ $m->company_id }}" @if($d->company_id==$m->company_id) selected @endif>{{ $m->company_name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="rui--e0m_">
                                                <div class="rui-yDKiM">
                                    ...
                                    <div class="rui-2zbKc">
                                        ...
                                        <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                             <select id="txtmodel" name="txtmodel" class="rui-1ekfu rui-98Wif" data-aut-id="ddmake" >
                                                 @foreach($olddata as $m)
                                                 <option value="{{ $m->model_id }}" @if($d->model_id==$m->model_id) selected @endif>{{ $m->model_name }}</option>
                                                 @endforeach
                                            </select>
                                            <div class="rui--e0m_">
                                                <div class="rui-yDKiM">
                                                 ...
                                                 <input type="hidden" name="oldimg" value="{{ $d->img1 }}"/>
                                                 <input type="hidden" name="oldimg1" value="{{ $d->img2 }}"/>
                                                 <input type="hidden" name="oldimg2" value="{{ $d->img3 }}"/>

                                                        <input type="hidden" name="oldid" value="{{ $d->o_id }}"/>
                                                <div class="rui-2AH6h">
                                                    <svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                        <path class="rui-u_VZV" d="M85.392 277.333h60.331l366.336 366.336 366.336-366.336h60.331v60.331l-408.981 409.003h-35.307l-409.045-409.003z">
                                                        </path>
                            ...
                            <div class="oogMA">
                                <div class="rui-2zbKc">
                                    ...
                                    <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;" style="width: 500px;">
                                        <div class="rui-RcLUE">
                                            <div class="rui-3wYvC">
                                                <input  name="txtyear" type="number"  class="rui-1ekfu rui-3oSYn" data-aut-id="inyear"  value="{{ $d->year }}" >
                                                <div class="rui-1ckrC">
                                                    <div class="rui-yDKiM">
                                                        <svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                            <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                            ...
                            <div class="oogMA">
                                <div class="rui-2zbKc">
                                    ...
                                    <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                        <div class="rui-RcLUE">
                                            <div class="rui-3wYvC">
                                                <input id="mileage" name="txtkm" value="{{ $d->km }}" type="number" autocomplete="off" class="rui-1ekfu rui-3oSYn" maxlength="6" data-aut-id="inmileage" min="0" step="1" value="" >
                                                <div class="rui-1ckrC">
                                                    <div class="rui-yDKiM">
                                                        <svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                            <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                            ...
                            <div class="oogMA">
                                <div class="rui-2zbKc">
                                    ...
                                    <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                        <div class="rui-RcLUE">
                                            <div class="rui-3wYvC">
                                                <input id="mileage" name="txtvehiclenumber" value="{{ $d->vehicle_numbers }}" type="text" autocomplete="off" class="rui-1ekfu rui-3oSYn" data-aut-id="inmileage" >
                                                <div class="rui-1ckrC">
                                                    <div class="rui-yDKiM">
                                                        <svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                            <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                        ...
                        <div class="rui-2zbKc">
                            ...
                            <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                <textarea autocomplete="off" data-aut-id=""   id="description" class="rui-1ekfu rui-329KC" maxlength="4096" name="txtaboutvehicle" placeholder="" style="height: 96px;" >{{ $d->About_vehicle }}</textarea><div class="rui-QRPFJ">
                                    <div class="rui-yDKiM">
                                        <svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                            <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                                            </path>
                            ...
                            <div class="rui-2zbKc">
                                ...
                                <div class="rui-D-GoM rui-33EYo" style="width: 500px;">
                                    <div class="rui-RcLUE rui-2gVGR">
                                        ...
                                        <div class="rui-3wYvC"><input id="price" name="txtprice" value="{{ $d->price }}" type="text" autocomplete="off" class="rui-1ekfu rui-3oSYn" data-aut-id="inPrice" min="0" pattern="(\d+[., \s]?\d?)*" value="">
                        ...
                        <div class="_2vNUv" aria-disabled="false">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <div class="_36uzR" >
                                    <img id="blah" src="{{URL::to('/')}}/oldvehicle_img/{{ $d->img1 }}" alt="Select Your image" />
                                    </div>
                             </div>
                            </td>
                            <td>
                                <input type='file' name="txtimg2"  onchange="readURL1(this);" />
                                 <div class="_1SuBk _24pdo" style="width:200px; height:200px;">
                                    <div class="_36uzR">
                                         <img id="blah1" src="{{URL::to('/')}}/oldvehicle_img/{{ $d->img2 }}" alt="Select Your image" />
                                     </div>
                                </div>
                            </td>
                            <td>
                                 ...
                                 <div class="_1SuBk _24pdo" style="width:200PX; height:200px;">
                                    <div class="_36uzR">
                                        <img id="blah2" src="{{URL::to('/')}}/oldvehicle_img/{{ $d->img3 }}" alt="Select Your image" />
                                    </div>
                                 </div>
                             </td>
                             </tr>
                                    ...
                                    <div class="rui-2zbKc">
                                        ...
                                        <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                            <select id="sid" onchange="loadcity(this.value);" name="sid" class="rui-1ekfu rui-98Wif" data-aut-id="ddmake" >
                                                 <option value=""></option>
                                                @foreach($state as $m)
                                               <option value="{{ $m->state_id }}"@if($d->state_id==$m->state_id) selected @endif>{{ $m->state_name }}</option>
                                                @endforeach
                                            </select>
                                            <div class="rui--e0m_">
                                                <div class="rui-yDKiM">
                                    ...
                                    <div class="rui-2zbKc">
                                        ...
                                        <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                             <select id="txtcity" name="txtcity" class="rui-1ekfu rui-98Wif" data-aut-id="ddmake" >
                                                @foreach($citydata as $m)
                                                 <option value="{{$m->city_id}}" @if($d->city_id==$m->city_id) selected @endif>{{$m->city_name}}</option>
                                                 @endforeach
                                            </select>
                                            <div class="rui--e0m_">
                                                <div class="rui-yDKiM">
                                        ...
                                        <div class="tBInl">
                                            <div class="rui-2zbKc">
                                                ...
                                                <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                                    <div class="rui-RcLUE">
                                                        <div class="rui-3wYvC">
                                                            <input id="title"  name="txtaddrsline1" value="{{$d->addressline1}}" type="text" autocomplete="off" class="rui-1ekfu rui-3oSYn" maxlength="70"  >
                                                            <div class="rui-1ckrC">
                                        ...
                                        <div class="tBInl">
                                            <div class="rui-2zbKc">
                                                ...
                                                <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                                    <div class="rui-RcLUE">
                                                        <div class="rui-3wYvC">
                                                            <input id="title" name="txtaddrsline2" value="{{$d->addressline2}}" type="text" autocomplete="off" class="rui-1ekfu rui-3oSYn" maxlength="70" >
                                                            <div class="rui-1ckrC">
                                                                <div class="rui-yDKiM"><svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                                    <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                                                                    </path>
                                        ...
                                        <div class="tBInl">
                                            <div class="rui-2zbKc">
                                                ...
                                                <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                                    <div class="rui-RcLUE">
                                                        <div class="rui-3wYvC">
                                                            <input id="title" name="txtlandmark" type="text" value="{{$d->landmark}}" autocomplete="off" class="rui-1ekfu rui-3oSYn" maxlength="70"  >
                                                            <div class="rui-1ckrC">
                                                                <div class="rui-yDKiM"><svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                                    <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                                                                    </path>
                                        ...
                                        <div class="tBInl">
                                            <div class="rui-2zbKc">
                                                ...
                                                <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;">
                                                    <div class="rui-RcLUE">
                                                        <div class="rui-3wYvC">
                                                            <input id="title" name="txtpincode" value="{{$d->pincode}}" type="text" autocomplete="off" class="rui-1ekfu rui-3oSYn" maxlength="70"  >
                                                            <div class="rui-1ckrC">
                                                                <div class="rui-yDKiM"><svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                                    <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                                                                    </path>
                             ...
                             <div class="oogMA">
                                <div class="rui-2zbKc">
                                    ...
                                    <div class="rui-D-GoM rui-33EYo rui-1H_PK" style="width: 500px;" style="width: 500px;">
                                        <div class="rui-RcLUE">
                                            <div class="rui-3wYvC">
                                                <input  name="txtcontact" type="text" value="{{$d->contactno}}" autocomplete="off" class="rui-1ekfu rui-3oSYn" data-aut-id="inyear"  >
                                                <div class="rui-1ckrC">
                                                    <div class="rui-yDKiM">
                                                        <svg width="16px" height="16px" viewBox="0 0 1024 1024" data-aut-id="icon" class="" fill-rule="evenodd">
                                                            <path class="rui-2BsmJ" d="M744.727 450.484v-54.846h-54.846l-216.669 216.669-100.305-100.305h-54.846v54.846l127.728 127.728h54.846l244.092-244.092zM512 162.911c-192.485 0-349.091 156.606-349.091 349.091s156.606 349.091 349.091 349.091c192.485 0 349.091-156.606 349.091-349.091s-156.606-349.091-349.091-349.091v0zM512 938.669c-235.268 0-426.667-191.399-426.667-426.667s191.399-426.667 426.667-426.667c235.268 0 426.667 191.399 426.667 426.667s-191.399 426.667-426.667 426.667v0z">
                                    ...
                                    <div class="rui-2SwH7 rui-1JF_2">
                                        <div class="_1Hyzp">
                                            <input type="submit" style="width: 300px; text-transform:uppercase;" data-aut-id="btnPost" class="rui-3sH3b rui-2yJ_A rui-1zK8h _3bFmz" value="Continue">
