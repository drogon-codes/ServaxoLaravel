...
<div class="main-container container">
        <ul class="breadcrumb">
            ...
            <li><a href="/Users/Track">Track Parcel</a></li>
        </ul>
        <div class="card">
            <div class="card-body">
                <h2 class="card-title">Track Parcel</h2><br/>
                <!-- <p>If you already have an account with us, please login at the <a href="#">login page</a>.</p> -->
                    <form action="/track" method="post" enctype="multipart/form-data" class="form-horizontal clearfix">
                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        <div class="form-group">
                            <div class="col-sm-3">&nbsp;</div>
                            <div class="col-sm-6">
                                <input type="text" name="txtorderid" value="" id="input-firstname" class="form-control" placeholder="Enter your OrderID to track.(eg. 645125)" style="height: 45px; font-size: 20px;">
                            </div>
                            <div class="col-sm-3">&nbsp;</div>
                        </div>
                        <div class="col-sm-3">&nbsp;</div>
                        <div class="col-sm-6">
                            ...
                            <input type="submit" value="Track Parcel" class="form-control btn btn-danger" style="height: 50px; border-radius: 5px;">
                            </div>
                        </div>
                        <div class="col-sm-3">&nbsp;</div>
                    </form>
