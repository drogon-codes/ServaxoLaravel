    ...
    <div class="row">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="d-flex">
                        <div class="w-100">
                            <h3 class="mb-4"><b>Confirm Password</b></h3>
                        </div>
                            ...
                            <form  class="signin-form" action="/passwordCheck" method="post" id="form1">
                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">

                                @if(Session::get('message'))
                                    <div class="alert alert-danger" role="alert">
                                        <b><div>{{Session::get('message')}}</div></b>
                       ...
                       <div class="form-group mb-3">
                            ...
                            <input type="text" id="txtpassword" name="txtpassword" class="form-control " placeholder="New Password">
                        </div>

                    <div class="form-group mb-3">
                        <label class="label" for="password">Confirm Password</label>
                      <input type="password" id="txtconfirmpassword" name="txtconfirmpassword" class="form-control" placeholder="Confirm Password">
                    </div>
                    <div class="form-group">
                        <button type="submit" class="form-control btn btn-primary  px-3" >Save Password</button>
                    </div>
