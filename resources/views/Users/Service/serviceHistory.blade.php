                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-center">Pick-Up Date</td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">#{{ $item->user_vehicle_id  }}</td>
                                    ...
                                    <td class="text-center">{{ $item->pic_up_date }}</td>
                                    ...
                                    <td class="text-center">
                                    @if($item->type=="manual")
                                        <button type="button" class="btn btn-info" title="Get Details" data-toggle="tooltip" data-original-title="Get Details" style=" border-radius: 4px;" onclick="window.location='/Users/Service/serviceInformation/{{ $item->user_vehicle_id  }}'"><i class="fa fa-eye" style="font-size: 20px; padding-top: 2px;"></i></button>
                                        @else
                                        <button type="button" class="btn btn-info" title="Get Details" data-toggle="tooltip" data-original-title="Get Details" style=" border-radius: 4px;" onclick="window.location='/Users/Packages/packageInformation/{{ $item->user_vehicle_id  }}'"><i class="fa fa-eye" style="font-size: 20px; padding-top: 2px;"></i></button>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
