                    ...
                    <table class="table table-bordered table-hover">
                         <thead>
                            <tr>
                                ...
                                <td class="text-center">service_description</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <!-- <td class="text-center">
                                    <a href="product.html"><img width="85" class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" src="{{URL::to('/')}}/Userassets/image/catalog/demo/product/replacement/1.jpg">
                                    </a>
                                </td>
                                <td class="text-left"><a href="product.html">Aspire Ultrabook Laptop</a>
                                </td> -->
                                <td class="text-center">{{ $item->service_name }}</td>
                                <td class="text-center">{{ $item->service_description }}</td>
                                <td class="text-center">{{ $item->service_price }}</td>
                                <td class="text-center">{{ $item->isactive }}</td>
                                <td class="text-center">{{ $item->type }}</td>
                                <td class="text-center"><a class="btn btn-info" title="" data-toggle="tooltip" href="/Users/Service/servicedetail/{{ $item->service_id }}"  data-original-title="View"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
