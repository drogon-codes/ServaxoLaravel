...
<div class="main-container container">
        <ul class="breadcrumb">
            ...
            <li><a href="/Users/Track">Track Tow Request</a></li>
        </ul>
        <div class="card">
            <div class="card-body">
                <h2 class="card-title">Track Tow Request</h2><br/>
                <!-- <p>If you already have an account with us, please login at the <a href="#">login page</a>.</p> -->
                    <form action="/towstatus" method="post" enctype="multipart/form-data" class="form-horizontal clearfix">
                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        <div class="form-group">
                            <div class="col-sm-3">&nbsp;</div>
                            <div class="col-sm-6">
                                <input type="text" name="txttrackid" value="" id="input-firstname" class="form-control" placeholder="Enter your Tow-ID to get status.(eg. 645125)" style="height: 45px; font-size: 20px;">
                            </div>
                            <div class="col-sm-3">&nbsp;</div>
                        </div>
                        <div class="col-sm-3">&nbsp;</div>
                        <div class="col-sm-6">
                            ...
                            <input type="submit" value="Track Tow" class="form-control btn btn-danger" style="height: 50px; border-radius: 5px;">
                            </div>
                        </div>
                        <div class="col-sm-3">&nbsp;</div>
                    </form>
