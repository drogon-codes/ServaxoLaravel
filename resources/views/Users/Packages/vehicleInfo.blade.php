...
<script type="text/javascript" src="{{URL::to('/')}}/Userassets/js/themejs/addtocart.js"></script><script src="{{URL::to('/')}}/Userassets/js/jquery.validate.min.js"></script>
...
<div class="main-container container">
        ...
        <div class="row">
            ...
            <form method="post" action="/getVehicleInfo" id="form1">
              <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                  <div>
                    <div>
                      <h4><i class="fa fa-book"></i> Your Vehicle Info</h4>
                    </div>
                      <div>
                            <fieldset id="address" class="required">
                              <div class="form-group required">
                                <label>Company</label>
                                <select id="cid" onchange="loadModel(this.value);" name="cid" class="form-control" data-aut-id="ddmake" >
                                                 <option value=""></option>
                                                @foreach($brand as $m)
                              ...
                              <div class="form-group required">
                                <label>Model</label>
                                <select id="txtmodel" name="txtmodel" class="form-control" data-aut-id="ddmake" >
                                    <option value=""> </option>
                                </select>
                              </div>
                              <div class="form-group required">
                                <label for="input-payment-postcode" class="control-label">Vehicle Number</label>
                                <input type="text" class="form-control" id="input-payment-postcode" placeholder="eg. AB-03 1234" value="" name="txtvehiclenumber">
                              </div>
