                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    <td class="text-right"><b>Under {{ $item->pkg_title }} Package (-{{$item->discount}}%)</b>
                                    </td>
                                    <td class="text-right"><b>₹ <?php echo $tot-($tot*($item->discount)/100)?>/-</b></td>
                                </tr>
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <td class="text-left">Vehicle Details</td>
                                    <td>&nbsp;</td>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ Session::get('vehicleNumber') }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
