...
<div class="main-container container">
        <ul class="breadcrumb">
            ...
            <li><a href="#">Package Checkout</a></li>
        </ul>
        ...
        <div class="row">
            <!--Middle Part Start-->
            <form action="/placePackageOrder" method="post">
              <input type="hidden" name="txttype" value="package">
        ...
        <div class="col-sm-9">
              ...
              <table class="table table-bordered">
                ...
                <input type="hidden" name="txtpkgid" value="{{$item->pkg_id}}">
                ...
                <tr>
                  ...
                  <tr>
                        <td class="text-right" colspan="3">
                            ...
                            <td class="text-right" colspan="2"><strong>₹ <?php echo $total; ?>/-<strong></td>
                        </tr>
                        <tr>
                        <td class="text-right" colspan="3">
                            <strong>Under {{ $item->pkg_title }} Package({{ $item->discount }}% off):</strong>
                            </td>
                            <?php $dis = ($item->discount);?>
                            <td class="text-right" colspan="2"><strong><strike>₹ <?php echo $total; ?>/-</strike>&emsp;₹ <?php echo $total-(($total*$dis)/100); ?>/-<strong></td>
                        </tr>
                </tbody>
              </table>
            </div>
