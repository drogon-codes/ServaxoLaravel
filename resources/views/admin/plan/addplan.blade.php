                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Plan - Add Plan</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            @endif
                                        <h4 class="card-title mb-4">Add New Plan</h4>
                                        <div class="text-sm-right">
                                            ...
                                            <form method="post" action="/insertplan" style="align-items:center;" enctype="multipart/form-data" id="form1">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                       ...
                                                       <select class="form-control" name="txtins">
                                                           @foreach($inscompanydata as  $index => $row)
                                                            <option value="{{ $row->ins_id }}">{{ $row->com_name }}</option>
                                                            @endforeach
                                                       </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="txtplantitle">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Plan Description</label>
                                                        <input type="text" class="form-control" name="txtplandesc">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="txtvalidity">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
