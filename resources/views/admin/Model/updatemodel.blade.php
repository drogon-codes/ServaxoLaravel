                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Models - Update Model</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif 
                                        <h4 class="card-title mb-4">Update New Model</h4>
                                        <div class="text-sm-right">
                                            <button type="button" class="btn btn-sm btn btn-warning w-md" onclick="window.location='/admin/Model/ViewModel'">View Models</button>
                                        </div>
                                          @foreach($modeldata as $d)
                                            <form method="post" action="/savemodel" style="align-items:center" enctype="multipart/form-data" id="form1">
                                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="row">                                                
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Model Name</label>
                                                        <input type="text" class="form-control" name="txtmodelname" value="{{ $d->model_name }}">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="txtcompany">
                                                           @foreach($companydata as  $index => $row)
                                                            <option value="{{ $row->company_id }}" @if($d->company_id==$row->company_id) selected @endif>{{ $row->company_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Model Image</label>
                                                        <input type="file" class="" name="txtmodelimg">
                                                        <input type="hidden" name="oldimg" value="{{ $d->model_img }}"/>
                                                        <input type="hidden" name="modelid" value="{{ $d->model_id }}"/>
                                                        <img src="{{URL::to('/')}}/model_img/{{ $d->model_img}}" width="100" height="100"/>
                                                    </div>
                                                </div>
                                            </div>
