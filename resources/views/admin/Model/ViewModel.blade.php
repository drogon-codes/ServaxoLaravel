                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Model - All Models</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-right">
                                            <button type="button" class="btn btn-dark waves-effect waves-light" onclick="window.location='/admin/Model/AddModel';">Add Model</button>
                                        </div>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->company_name  }}</td>
                                                 <td><img src="{{URL::to('/')}}/model_img/{{ $row->model_img}}" width="100" height="100"/></td>
                                                <td>
                                                    <button type="button" class="btn btn-outline-primary btn btn-sm waves-effect waves-light" onclick="window.location='/admin/Model/updatemodel/{{ $row->model_id }}';">Edit</button>
                                                     <button data-id="{{ $row->model_id }}" type="button" class="btn btn-outline-danger btn btn-sm  waves-effect waves-light open-dialog" data-toggle="modal" data-target="#myModal">Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form method="post" action="/deletemodel">
