                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Insurance Companies - Update Insurance Company</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Update Insurance Company</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @foreach($inscompanydata as $d)
                                        <form action="/saveinscompany" method="post" style="align-items:center;" enctype="multipart/form-data" id="form1">
                                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="row"> 
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Company Name</label>
                                                        <input type="text" class="form-control"  name="txtcompanyname" value="{{ $d->com_name }}">
                                                    </div>
                                                </div>
                                                 <div class="col-md-6">
                                                     <div class="form-group">
                                                        <label for="formrow-email-input">Policy Name</label>
                                                        <input type="text" class="form-control" name="txtpolicyname" value="{{ $d->p_name }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                     <div class="form-group">
                                                        <label for="formrow-email-input">Contact No</label>
                                                        <input type="text" class="form-control" name="txtcontact" value="{{ $d->contact }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                     <div class="form-group">
                                                        <label for="formrow-email-input">Email ID</label>
                                                        <input type="text" class="form-control" name="txtemailid" value="{{ $d->email }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                     <div class="form-group">
                                                        <label for="formrow-email-input">Addressline 1</label>
                                                        <textarea class="form-control" name="txtaddressline1">{{ $d->addressline1 }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                     <div class="form-group">
                                                        <label for="formrow-email-input">Addressline 2</label>
                                                        <textarea class="form-control" name="txtaddressline2" cols="3">{{ $d->addressline2 }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                     <div class="form-group">
                                                        <label for="formrow-email-input">Website URL</label>
                                                        <input type="text" class="form-control" name="txtwebsiteurl" value="{{ $d->website }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                     <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                     <div class="form-group">
                                                        ...
                                                        <img src="{{URL::to('/')}}/inscomp_img/{{ $d->logo }}" width="100" height="100"/>
                                                        <input type="hidden" name="oldimg" value="{{ $d->logo }}"/>
                                                        <input type="hidden" name="insid" value="{{ $d->ins_id }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                     <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" name="txtabout">{{ $d->about  }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
