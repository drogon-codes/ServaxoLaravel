                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage News - Add News</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-sm-right">
                                            ...
                                            <form method="post" action="/insertnews" style="align-items:center" enctype="multipart/form-data" id="form1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">IsActive</label>
