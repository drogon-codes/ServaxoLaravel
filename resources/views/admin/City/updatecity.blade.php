                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage City - Update City</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif 
                                        <h4 class="card-title mb-4">Update New City</h4>
                                        <div class="text-sm-right">
                                         ...
                                         @foreach($citydata as $d)
                                            <form method="post" action="/savecity" style="align-items:center" id="form1">
                                            ...
                                            <div class="row">                                                
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $d->city_name }}" name="txtcityname">
                                                        <input type="hidden" name="cityid" value="{{ $d->city_id }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">City Code</label>
                                                        <input type="text" class="form-control" value="{{ $d->city_code }}" name="txtcitycode">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="formrow-email-input">State Name</label>
                                                     <select class="form-control" name="txtstate">
                                                        ...
                                                        <option @if($d->state_id==$row->state_id) selected @endif value="{{ $row->state_id }}">{{ $row->state_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
