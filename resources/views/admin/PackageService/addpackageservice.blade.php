...
@section('title')
Add Package Service - Manage Package
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Package Service - Add Package</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Add Package Service</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        ...
                                        @if(Session::get('message'))
                                         ...
                                         @endif
                                            <h4 class="card-title mb-4">Add New Package Service</h4>
                                            <div class="text-sm-right">
                                                <button type="button" class="btn btn-sm btn btn-warning w-mdw-md" onclick="window.location='/admin/PackageService/viewpackageservice'">View Package Service</button>
                                            </div>
                                            <form method="post" action="/insertpackageservice" style="align-items:center" enctype="multipart/form-data" id="form1">
                                                ...
                                                <div class="row">                                 
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <option value="{{ $row->pkg_id }}">{{ $row->pkg_title }}</option>
                                                            @endforeach
                                                        </select>
                                                        </div>
                                                    </div>
