                                    ...
                                    <div class="card">
                                        ...
                                        @if(Session::get('message'))
                                         ...
                                         @endif
                                            ...
                                            <form method="post" action="/insertpackage" style="align-items:center" enctype="multipart/form-data" id="form1">
                                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                                <div class="row">                                 
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="formrow-email-input">Package Title</label>
                                                            <input type="text" class="form-control" name="txtpackagetitle">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="formrow-email-input">Package Description</label>
                                                            <textarea name="txtpackagedes" class="form-control" rows="1"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="txtdiscount" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="Radio" class=""  name="optradio" value="yes" checked>Yes
                                                             <input type="Radio" class=""  name="optradio" value="no">No
                                                             </div>
                                                        </div>
                                                    </div>
                                                </div>
