                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage State - All States</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-primary btn btn-sm waves-effect waves-light" onclick="window.location='/admin/State/updatestate/{{ $row->state_id }}'">Edit</button>
                                                    <button data-id="{{ $row->state_id }}" type="button"  data-toggle="modal" data-target="#myModal" class="btn btn-outline-danger btn btn-sm  waves-effect waves-light open-dialog">Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="post" action="/deletestate">
