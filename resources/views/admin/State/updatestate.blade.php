                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage State - Update State</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <h4 class="card-title mb-4">Update New State</h4>
                                        <div class="text-sm-right">
                                            <button type="button" class="btn btn-sm btn btn-warning w-md" onclick="window.location='/admin/State/ViewState'">View States</button>
                                        </div>
                                        @foreach($statedata as $d)

                                            <form method="post" action="/savestate" style="align-items:center" id="form1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $d->state_name }}" name="txtstatename">
                                                        <input type="hidden" name="stateid" value="{{ $d->state_id }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">State Code</label>
                                                        <input type="text" class="form-control"  name="txtstatecode" value="{{ $d->state_code }}">
                                                    </div>
                                                </div>
                                            </div>
    ...
    $("#form1").validate({
        ...
        messages:
        {
            txtstatename:
            {
                ...
                lettersonly:"Enter valid state name"
            },
            txtstatecode:
            {
                required:"Please Enter State Code",
                lattersonly:"Allowed only letters",
