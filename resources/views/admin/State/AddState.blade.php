                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage State - Add State</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-sm-right">
                                            ...
                                            <form method="post" action="/insertstate" style="align-items:center" id="form1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  name="txtstatename">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">State Code</label>
                                                        <input type="text" class="form-control"  name="txtstatecode">
                                                    </div>
                                                </div>
                                            </div>
    ...
    $("#form1").validate({
        ...
        messages:
        {
            txtstatename:
            {
                ...
                maxlength:"Please Enter Valid State Name",
