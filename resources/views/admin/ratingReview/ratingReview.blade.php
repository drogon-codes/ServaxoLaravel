                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Reviews - All Reviews</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                <td>{{ ++$index }}</td>
                                                <!-- <td>{{ $row->user_vehicle_id }}</td> -->
                                                <td>{{ $row->name }}</td>
                                                <td>{{ $row->rating }}</td>
                                                <td>{{ $row->reviews_text }}</td>
                                                <td>
                                                    <!-- <button type="button" class="btn btn-outline-primary btn btn-sm waves-effect waves-light">Edit</button> -->
                                                    <button data-id="{{ $row->r_id }}" type="button" class="btn btn-outline-danger btn btn-sm  waves-effect waves-light waves-light open-dialog" data-toggle="modal" data-target="#myModal" >Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
