                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->total_payment  }}</td>
                                                 ...
                                                 <td>{{ $row->pincode }}</td>
                                                 <td>{{ $row->city_name  }}</td>
                                                 <td><button data-id="{{ $row->order_id  }}" data-status="{{ $row->status }}" type="button" class="btn btn-outline-success btn btn-sm  waves-effect waves-light open-status-dialog" data-toggle="modal" data-target="#myModalstatus">Send for Process</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h5>Are you sure Delete Record?</h5>
                             
                            </div>
                            <div class="modal-footer">
                                <form method="post" action="/deleteneworder">
                ...
                <div id="myModalstatus" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h5>Are you sure Order Send to Process?</h5>
              ...
              <div id="myModalstatus1" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h5>Are you sure Cancel the Order?</h5>
