...
@section('main-content')
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                            @foreach($viewfeedbackdata as $index => $row)
                                            <tr>
                                                <td>{{ ++$index }}</td>
                                                <td>{{ $row->name }}</td>
                                                <td>{{ $row->contact }}</td>
                                                <td>{{ $row->email }}</td>
                                                <td>{{ $row->feed_text }}</td>
                                                <td>{{ $row->feed_datetime }}</td>
                                                <td>
                                                    <!-- <button type="button" class="btn btn-outline-primary btn btn-sm waves-effect waves-light">Edit</button> -->
                                                    <button data-id="{{ $row->feed_id }}" type="button" class="btn btn-outline-danger btn btn-sm  waves-effect waves-light open-dialog" data-toggle="modal" data-target="#myModal">Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="/deleteviewfeedback">
