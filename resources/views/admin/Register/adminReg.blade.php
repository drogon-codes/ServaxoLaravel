...
<!-- Mirrored from themesbrand.com/skote/layouts/form-layouts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Dec 2020 08:08:07 GMT -->
<head>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{URL::to('/')}}/{{URL::to('/')}}/assets/images/logo-light.svg" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                                    <img src="{{URL::to('/')}}/{{URL::to('/')}}/assets/images/flags/russia.jpg" alt="user-image" class="mr-1" height="12"> <span class="align-middle">Russian</span>
                                </a>
                            </div>
                        </div>
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    ...
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input theme-choice" id="dark-mode-switch" data-bsStyle="{{URL::to('/')}}/assets/css/bootstrap-dark.min.css" data-appStyle="assets/css/app-dark.min.css" />
