                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Training Schools - Add Training Schools</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Add Training School</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">Add New Training School</h4>
                                        ...
                                        <form action="/inserttrainingschool" method="post" style="align-items:center;" enctype="multipart/form-data" id="form1">
                                            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="row">
                                                <div class="col-md-6">        
                                                     <div class="form-group">
                                                        <label for="txtpartname">School Name</label>
                                                        <input type="text" class="form-control" name="txtschoolname">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       ...
                                                       <textarea class="form-control" name="txtaddressline1" id="txtaddressline1"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       ...
                                                       <textarea class="form-control" name="txtaddressline2"></textarea>
                                                    </div>
                                                </div>
