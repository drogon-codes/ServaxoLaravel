                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Parts - Update Part</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif 
                                        <h4 class="card-title mb-4">Update New Part</h4>
                                        <div class="text-sm-right">
                                            <button type="button" class="btn btn-sm btn btn-warning w-md" onclick="window.location='/admin/Parts/ViewParts'">View Parts</button>
                                        </div>
                                        @foreach($partsdata as $d)
                                        <form method="post" action="/saveparts" style="align-items:center" enctype="multipart/form-data" id="form1">
                                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">

                                                <input type="hidden" name="partid" value="{{$d->part_id}}"/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="txtmodel">
                                                            ...
                                                            <option @if($d->model_id==$row->model_id) selected @endif value="{{ $row->model_id }}">{{ $row->model_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Part Name</label>
                                                        <input type="text" class="form-control" value="{{ $d->part_name }}" name="txtpartname">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Price</label>
                                                        <input type="text" class="form-control" value="{{ $d->price }}" name="txtpartprice">
                                                    </div>
                                                </div>
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="txtcategory">
                                                            ...
                                                            <option @if($d->catgory_id==$row->catagory_id) selected @endif value="{{ $row->catagory_id }}">{{ $row->catagory_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Part Description</label>
                                                        <textarea class="form-control" name="txtpartdescription">{{ $d->part_description }}</textarea>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Image 1</label>
                                                        <input type="file" class="" name="txtpartimg1">
                                                        <input type="hidden" name="oldimg" value="{{ $d->img1 }}"/>
                                                        <input type="hidden" name="partid" value="{{ $d->part_id }}"/>
                                                        <img src="{{URL::to('/')}}/part_img/{{ $d->img1 }}" width="100" height="100"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Image 2</label>
                                                        <input type="file" class="" name="txtpartimg2">
                                                        <input type="hidden" name="oldimg1" value="{{ $d->img2 }}"/>
                                                        <img src="{{URL::to('/')}}/part_img/{{ $d->img2 }}" width="100" height="100"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Image 3</label>
                                                        <input type="file" class=""  name="txtpartimg3">
                                                        <input type="hidden" name="oldimg2" value="{{ $d->img3 }}"/>
                                                        <img src="{{URL::to('/')}}/part_img/{{ $d->img3 }}" width="100" height="100"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Part Manual PDF</label>
                                                        <input type="file" class=""  name="txtpartmanualpdf">
                                                        <input type="hidden" name="oldimg3" value="{{ $d->part_manual_pdf }}"/>
                                                        <img src="{{URL::to('/')}}/part_img/{{ $d->part_manual_pdf }}" width="100" height="100"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Video URL</label>
                                                        <div>
                                                        <input type="text" class="" value="{{ $d->video_url }}" name="txtpartvideourl">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Radio" @if($d->isactive=="yes") checked @endif  class="" name="radradio" value="yes" >Yes
                                                         <input @if($d->isactive=="no") checked @endif type="Radio" class="" name="radradio" value="no">No
                                                     </div>
                                                    </div>
                                                </div>
                                            </div>
