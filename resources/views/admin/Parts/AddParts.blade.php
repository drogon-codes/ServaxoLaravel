                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Parts - Add Part</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">Add New Part</h4>
                                        ...
                                        <form method="post" action="/insertparts" style="align-items:center" enctype="multipart/form-data" id="form1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"  name="txtpartname">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Price</label>
                                                        <input type="text" class="form-control"  name="txtpartprice">
                                                    </div>
                                                </div>
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Catagory Name</label>
                                                        <select class="form-control" name="txtcatagory">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control"  name="txtpartdescription"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                        <input type="text" class="" name="txtpartvideourl">
                                                    </div>
                                                    </div>
                                                </div>
...
<script>
    $("#form1").validate({
        ...
        messages:
        {
            ...
            txtpartmanualpdf:
            {
                required:"Please Enter Manual PDF",
