                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Company - Add Company</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">Add New Company</h4>
                                            <div class="text-sm-right">   
                                              ...
                                              <form method="post" action="/insertcompany" style="align-items:center" enctype="multipart/form-data" id="form1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Radio" class="" name="radradio" value="car"checked>Car
                                                         <input type="Radio" class=""  name="radradio" value="bike">Bike
                                                     </div>
                                                    </div>
                                                </div>
                                            </div>
