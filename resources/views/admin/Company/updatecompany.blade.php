                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Company - Update Company</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif 
                                        <h4 class="card-title mb-4">Update New Company</h4>
                                            <div class="text-sm-right">   
                                              <button type="button" class="btn btn-sm btn btn-warning w-md" onclick="window.location='/admin/Company/ViewCompany'">View Companies</button>  
                                            </div>
                                            @foreach($companydata as $d)
                                              <form method="post" action="/savecompany" style="align-items:center" enctype="multipart/form-data" id="form1">
                                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                                <div class="row">                                              
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Company Name</label>
                                                        <input type="text" class="form-control" value="{{ $d->company_name }}" name="txtcompanyname">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Company logo</label>
                                                        <input type="file" class="" name="txtcompanylogo">
                                                        <input type="hidden" name="oldimg" value="{{ $d->company_logo }}"/>
                                                        <input type="hidden" name="comid" value="{{ $d->company_id }}"/>
                                                        <img src="{{URL::to('/')}}/company_img/{{ $d->company_logo }}" width="100" height="100"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Radio" class="" name="radradio" value="car" @if($d->company_type=="car") checked @endif>Car
                                                         <input type="Radio" class=""  name="radradio" value="bike" @if($d->company_type=="bike") checked @endif>Bike
                                                     </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <button type="Reset" class="btn btn-secondary w-md" >Reset
                                                </button>
                                            </div>
                                        </form>
                                        @endforeach
