                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Services - Add Service</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-sm-right">
                                            ...
                                            <form method="post" action="/insertservice" style="align-items:center" id="form1" enctype="multipart/form-data">
                                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="row">                                                
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Service Name</label>
                                                        <input type="text" class="form-control"  name="txtservicename">
                                                    </div>
                                                </div>
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Service Description</label>
                                                        <textarea class="form-control"  name="txtservicedes"></textarea>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Service Price</label>
                                                        <input type="text" class="form-control"  name="txtserviceprice">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
