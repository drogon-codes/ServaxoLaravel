...
@section('title')
Update Services - Manage Services
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Services - Update Service</h4>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @endif 
                                        <h4 class="card-title mb-4">Update New Service</h4>
                                        <div class="text-sm-right">
                                            <button type="button" class="btn btn-sm btn btn-warning w-md" onclick="window.location='/admin/Services/ViewServices'">View Services</button>
                                        </div>
                                        @foreach($servicedata as $d)
                                            <form method="post" action="/saveservice" style="align-items:center" id="form1" enctype="multipart/form-data">
                                                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                                            <div class="row">                                                
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Service Name</label>
                                                        <input type="text" class="form-control" value="{{ $d->service_name }}" name="txtservicename">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Service Images</label>
                                                        <div>
                                                        <input type="file" class="" name="serviceimg">
                                                        <img src="{{URL::to('/')}}/serv_img/{{ $d->service_img }}" width="100" height="100"/>
                                                        <input type="hidden" name="oldimg" value="{{ $d->service_img }}"/>
                                                        <input type="hidden" name="serviceid" value="{{ $d->service_id }}"/>
                                                    </div>
                                                    </div>
                                                </div>
                                                 <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Service Description</label>
                                                        <textarea class="form-control"  name="txtservicedes">{{ $d->service_description }}</textarea>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Service Price</label>
                                                        <input type="text" class="form-control" value="{{ $d->service_price }}" name="txtserviceprice">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
