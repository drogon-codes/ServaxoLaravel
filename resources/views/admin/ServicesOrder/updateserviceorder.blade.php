...
@section('title')
Update New Service Order - Manage Services
@endsection
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage New Services - Update Services Order</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Update New Service Order</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">Update New Service Order</h4>
                                        ...
                                        <form action="/saveserviceorder" style="align-items:center;" method="post" id="form1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="txtuserid">
                                                            ...
                                                            <option @if($d->user_id==$row->user_id) selected @endif value="{{ $row->user_id }}">{{ $row->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="txtmodelid">
                                                            ...
                                                            <option value="{{ $row->model_id }}" @if($d->model_id==$row->model_id) selected @endif>{{ $row->model_name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="txtvehicleno" value="{{ $d->vehicale_no }}">
                                                        <input type="hidden" name="sorderid" value="{{ $d->user_vehicle_id }}"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Remark</label>
                                                        <input type="text" class="form-control" name="txtremark" value="{{ $d->remark }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Total Payment</label>
                                                        <input type="text" class="form-control" name="txttotal" value="{{ $d->total_payment }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Pickup date</label>
                                                        <input type="Date" class="form-control" name="txtpicupdate" value="{{ $d->pic_up_date }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Addressline1</label>
                                                        <textarea class="form-control" name="txtadd1">{{ $d->Addressline1 }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Addressline2</label>
                                                        <textarea class="form-control" name="txtadd2">{{ $d->Addressline2 }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="txtlandmark" value="{{ $d->landmark }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Order DateTime</label>
                                                        <input type="Date" class="form-control" name="txtorderdate" value="{{ $d->order_datetime }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 ">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="optorder">
                                                            ...
                                                            <option @if($d->user_vehicle_id ==$row->user_vehicle_id ) selected @endif value="{{ $row->user_vehicle_id }}">{{ $row->status }}</option>
                                                            @endforeach
