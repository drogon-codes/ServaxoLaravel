                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-right">
                                            <button type="button" class="btn btn-dark waves-effect waves-light" onclick="window.location='/admin/ServicesOrder/AddNewOrder';">Add New order</button>
                                        </div>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->pincode }}</td>
                                                <td>{{ $row->landmark }}</td>
                                                <td><button data-id="{{ $row->user_vehicle_id }}" data-status="{{ $row->status }}" type="button" class="btn btn-outline-success btn btn-sm  waves-effect waves-light open-status-dialog" data-toggle="modal" data-target="#myModalstatus">Send for processing</button>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-primary btn btn-sm waves-effect waves-light" onclick="window.location='/admin/ServicesOrder/updateserviceorder/{{ $row->user_vehicle_id }}';">Edit</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form method="post" action="/deletenewserviceorder">
                ...
                <div id="myModalstatus" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form method="post" action="/changesorderstatus">
