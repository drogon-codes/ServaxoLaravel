                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-sm-right"><button type="button" class="btn btn-warning brn btn-sm w-md" onclick="window.location='/admin/ServicesOrder/ViewNewsOrder'">View Service Order</button></div>
