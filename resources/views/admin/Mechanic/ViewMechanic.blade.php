                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Mechanic - All Mechanic</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Manage Mechanic</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All Mechanic</h4>
                                        <div class="text-right">
                                            <button type="button" class="btn btn-dark waves-effect waves-light" onclick="window.location='/admin/Mechanic/AddMechanic';">Add Mechanic</button>
                                        </div>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach($mechanicdata as  $index => $row)
                                            <tr>
                                                <td>{{ ++$index }}</td>
                                                <td>{{ $row->city_name }}</td>
                                                <td>{{ $row->name }}</td>
                                                <td><img src="{{URL::to('/')}}/mach_img/{{ $row->mach_image }}" width="100" height="100"/></td>
                                                <td>{{ $row->iscar }}</td>
                                                <td>{{ $row->isbike }}</td>
                                                ...
                                                <td>
                                                    <button data-id="{{ $row->mach_id }}" data-status="{{ $row->isactive  }}" type="button" class="btn btn-outline-success btn btn-sm  waves-effect waves-light open-status-dialog" data-toggle="modal" data-target="#myModalstatus">{{ $row->isactive }}</button>
                                                </td>
                                                <!-- <td>{{ $row->isactive }}</td> -->
                                                <td>
                                                    <button type="button" class="btn btn-outline-primary btn btn-sm waves-effect waves-light" onclick="window.location='/admin/Mechanic/updatemechanic/{{ $row->mach_id }}';">Edit</button>
                                                    <button data-id="{{ $row->mach_id }}" type="button" class="btn btn-outline-danger btn btn-sm  waves-effect waves-light open-dialog"   data-toggle="modal" data-target="#myModal">Delete</button>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form method="post" action="/deletemechanic">
                ...
                <div id="myModalstatus" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <form method="post" action="/changemechanicstatus">
