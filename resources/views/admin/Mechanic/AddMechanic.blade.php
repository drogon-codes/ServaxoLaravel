                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">Manage Services - Add Mechanic</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                            <li class="breadcrumb-item active">Add Mechanic</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4">Add New Machanic</h4>
                                        ...
                                        <form action="/insertmechanic" method="post" style="align-items:center;" enctype="multipart/form-data" id="form1">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="txtmechanicname">
                                                    </div>
                                                </div>     
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Radio" class="" id="formrow-email-input" name="rdiscar" value="yes" checked>Yes
                                                         <input type="Radio" class="" id="formrow-email-input" name="rdiscar" value="no">No
                                                        </div>
                                                     </div>
                                                </div>   
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-radio">
                                                        <input type="Radio" class="" id="formrow-email-input" name="rdisbike" value="yes" checked>Yes
                                                         <input type="Radio" class="" id="formrow-email-input" name="rdisbike" value="no">No
                                                        </div>
                                                     </div>
                                                </div>  
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                       ...
                                                       <textarea type="text" class="form-control" name="txtaddrline1"></textarea>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Address Line 2</label>
                                                      <textarea type="text" class="form-control" name="txtaddrline2"></textarea>
                                                    </div>
                                                </div>  
                                                <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="txtlatitude" id="txtlatitude">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="formrow-email-input">Longitude</label>
                                                        <input type="text" class="form-control" name="txtlongtitude" id="txtlongtitude">
                                                    </div>
                                                </div>  
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-radio">
                                                            <input type="Radio" class="" id="formrow-email-input" name="rdisactive" value="yes" checked>Yes
                                                            <input type="Radio" class="" id="formrow-email-input" name="rdisactive" value="no">No
                                                        </div>
                                                     </div>
                                                </div> 
                                            </div>                                           
